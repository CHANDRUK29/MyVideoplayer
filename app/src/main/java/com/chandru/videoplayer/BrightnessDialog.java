...
public class BrightnessDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        close = view.findViewById(R.id.bright_cls);
        bright_no = view.findViewById(R.id.bright_number);
        seekBar = view.findViewById(R.id.bright_seek);

        seekBar.setMax(255);
        seekBar.setKeyProgressIncrement(1);

        seekBar.getProgressDrawable().setColorFilter(getResources().getColor(R.color.color1), PorterDuff.Mode.MULTIPLY);
...
//
//                if (canWrite) {
//                    int mbrightness = progress * 255 / 255;
//                    bright_no.setText(mbrightness + "");
//                    Settings.System.putInt(context.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS_MODE, Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL);
//                    Settings.System.putInt(context.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, mbrightness);
//
//                } else {
